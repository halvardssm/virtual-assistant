import { VirtualAssistantType,VirtualAssistantAudioType } from "../../lib/utils";

const soundsMp3: VirtualAssistantAudioType = {
  mime: "audio/mpeg",
  sounds:{
...
const soundsOgg: VirtualAssistantAudioType = {
  mime: "audio/ogg",
  sounds:{
...
const animations: VirtualAssistantType['animations']={
  Congratulate: {
    frames: [
